...
<?php
    ...
    $admins_counts = mysqli_num_rows($select_admin_users);

    $query = "SELECT * FROM users WHERE user_role = 'subscriber' ";
    $select_subscriber_users = mysqli_query($connection, $query);
    $subscribers_counts = mysqli_num_rows($select_subscriber_users);
?>
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ['Data', 'Count'],
                            <?php 
                            $element_text=['All Posts','Active Posts','Draft Posts','Comments','Unapproved Comments','Admin Users','Subscribers Users','Categories'];
                            $element_count = [$post_counts,$published_post_counts,$draft_post_counts, $comments_counts,$unapproved_comments_counts, $admins_counts,$subscribers_counts,$categories_counts];
